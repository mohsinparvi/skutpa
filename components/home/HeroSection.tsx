  ...
  return (
    <div className="flex items-center my-8 gap-20">
      <div className="w-2/5 space-y-4">
        <p className="bg-blue-300 text-blue-500 rounded-md px-2 py-4 font-semibold w-1/5">
          Sale 70%
        </p>
        ...
        <button className="flex items-center justify-center bg-slate-300 py-4 rounded-md gap-4 w-1/3">
